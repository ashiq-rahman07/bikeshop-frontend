...
const Order = () => {
  ...
  return isLoading? (<Loading/>) :(
    ...
    <div className="container mx-auto px-4">
      <h1 className="text-3xl font-poppins font-bold text-center mb-8">Order Details</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Order Details */}
        
         
          {orderData?.map((order,index) => (
                <div key={index} className="flex justify-between items-center border-b bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-lg shadow-md pb-2">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
