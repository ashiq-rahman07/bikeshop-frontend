      ...
      {cartItems.length === 0 ? (
        ...
        <div>
          ...
          <div className="mt-8 text-right">
            ...
            <Link to='/products' className=" flex  items-center justify-center hover:text-primary">
                <span>Continue Shopping</span> <FaLongArrowAltRight  className="pt-2 text-xl"/>
            </Link>
            <button onClick={handlePlaceOrder} className="mt-4 bg-primary text-white px-6 py-2 rounded hover:bg-primary-dark">
              Checkout
            </button>
            </div>
