    ...
    >
      <div className="container py-2 md:py-0">
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            <Link to='/'><span className="text-3xl font-bold font-serif">BIKE SHOP</span></Link>
          ...
          <nav className="hidden md:block">
            ...
            >
              <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="text-2xl font-medium hover:text-primary  py-2    ">
              <FaRegUserCircle />
              </button>
              ...
              {isDropdownOpen && (
                <div className="absolute text-gray-900 dark:text-gray-100 right-0 mt-2 w-48 bg-gray-200 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                  <div className="p-2">
                  <Link to="/dashboard" className=" block px-4 py-2 hover:text-primary">
              Dashboard
            </Link>
                    <Link
            ...
            <Link to="/signin" className="text-lg font-medium  hover:text-primary py-2 hover:border-b-2 hover:border-primary transition-colors duration-500">
              SIGN IN
            </Link>
          )}
