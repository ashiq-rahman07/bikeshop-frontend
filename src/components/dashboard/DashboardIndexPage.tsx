      ...
      <div className="p-6 bg-gray-100 dark:bg-gray-900 dark:text-gray-100 text-gray-900  min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {metrics.map((metric, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 dark:text-gray-100 p-6 rounded-lg shadow-md"
            >
            ...
            <table className="min-w-full dark:bg-gray-800 dark:text-gray-100">
              ...
              <tbody>
                {recentOrders.map((order) => (
                  <tr
                    key={order.id}
                    className="border-b dark:border-gray-600 border-gray-300 dark:bg-gray-800 dark:text-gray-100"
                  >
        ...
        <div className="bg-white dark:bg-gray-800 dark:text-gray-100 p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {inventoryAlerts.map((item, index) => (
              <div
                key={index}
                className="bg-red-50 dark:bg-gray-900 dark:text-gray-100 p-4 rounded-lg"
              >
