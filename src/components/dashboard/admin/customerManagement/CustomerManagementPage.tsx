...
import { useDeleteUserMutation, useGetUsersQuery, useUpdateUserMutation, useUpdateUserStatusMutation } from '../../../../redux/features/user/authApi';
        ...
        <div className="container mx-auto">
          ...
          <div className="rounded-lg shadow-md overflow-hidden">
            <table className="min-w-full text-cente">
              ...
              <tbody>
                {usersData?.map((user) => (
                  <tr key={user._id} className="border-b r hover:bg-gray-50 dark:hover:bg-gray-700">
