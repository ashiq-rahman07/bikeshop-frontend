...
const CustomerDashboardIndexPage: React.FC = () => {
  ...
  const recommendedProducts = [
    { id: '1', name: 'Mountain Bike', price: 499.99, image: 'https://i.ibb.co.com/VpsW90v/Modelo-de-motos-h-bridas.jpg' },
    { id: '2', name: 'Road Bike', price: 699.99, image: 'https://i.ibb.co.com/CH1RH13/NAWA-Technologies.jpg' },
    { id: '3', name: 'Cycling Helmet', price: 49.99, image: 'https://i.ibb.co.com/BnJZb7L/the-top-10-street-bikes-we-cant-wait-to-ride-in-2019-ducati-diavel.jpg' },
  ];
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-900 dark:text-gray-100 text-gray-950 min-h-screen">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="">Here's what's happening with your account today.</p>
      </div>
          ...
          <table className="min-w-full">
            ...
            <tbody>
              {recentOrders.map((order) => (
                <tr key={order.id} className="border-b dark:border-gray-700 space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800  p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {recommendedProducts.map((product) => (
            <div key={product.id} className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
              <img
                src={product.image}
                alt={product.name}
